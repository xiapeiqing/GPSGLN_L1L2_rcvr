function [all_G1, all_G2, all_CAcode, risingEdge1KHz] = CAcodeGenerator( sequenceLength, mode )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mode = 0: only all_CAcode is generated
% mode = 1; all_G1, all_G2, all_CAcode, risingEdge1KHz are generated
% [all_G1, all_G2, all_CAcode, risingEdge1KHz] = CAcodeGenerator( 10000, 1 );
% autocorr(all_CAcode , 9000 , 1500 , 2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
all_G1=[];
all_G2=[];
all_G1_outbit=[];
