...
clear all;
ConstantDefinition;
totalDataLenMilliSec = 10; % length of data in ms
numberOf6ms=1;
...
load '..\data'; % use load operation to save execution time
data_I(find(data_I==0)) = -1;
data_Q(find(data_Q==0)) = -1;

MAGSIGN = data_I + j*data_Q;
clear data_I data_Q;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[SVlist, all_ccn, all_frr, averaged_frr] = searchSV(MAGSIGN);
