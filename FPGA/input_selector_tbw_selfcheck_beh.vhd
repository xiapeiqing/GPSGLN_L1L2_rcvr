...
--
--Command: 
--Design Name: input_selector_tbw_selfcheck_beh
--Device: Xilinx
--
...
ENTITY input_selector_tbw_selfcheck_beh IS
END input_selector_tbw_selfcheck_beh;

ARCHITECTURE testbench_arch OF input_selector_tbw_selfcheck_beh IS
